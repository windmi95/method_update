    ...
    public boolean 퀘스트_유형_선택(int 퀘스트_번호_선택, int 퀘스트_승낙_여부_선택, int 캐릭터_레벨, int 캐릭터_등급) {
        if (퀘스트_번호_선택 == 1) {// 기본 퀘스트
            ...
            if (캐릭터_등급 == 1 && 캐릭터_레벨 >= 30) {//초급 -> 중급
                ...
                System.out.println("운동 횟수 100개를 실행해야 하며 랜덤으로 체력이 -3 감소됩니다.");
                ...
                System.out.println("운동 횟수 300개를 실행하지 못할 경우 랜덤으로 체력이 -5 감소됩니다.");
                System.out.println("운동 횟수를 채우지 못할 경우 다시 도전해야 합니다.");
                } else if (퀘스트_승낙_여부_선택 == 2) {
                    return 퀘스트_진행중 = false;
                }
                ...
                System.out.println("운동 실행을 선택했을 때 랜덤으로 체력이 -7 감소됩니다.");
                ...
                if (퀘스트_승낙_여부_선택 == 1) {
                    ...
                    System.out.println("운동 실행을 선택했을 때 랜덤으로 체력이 -10 감소됩니다.");
