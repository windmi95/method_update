...
public class 헬스장_관장 {
    ...
    public void 승급_가능_메시지_출력(캐릭터 캐릭터) {
        if (30 <= 캐릭터.레벨  && 캐릭터.레벨 < 31) {//초급
            System.out.println("중급 심사를 진행하실 수 있습니다.");
        } else if (50 <= 캐릭터.레벨 && 캐릭터.레벨 < 51) {//중급
            System.out.println("고급 심사를 진행하실 수 있습니다.");
        } else if (70 <= 캐릭터.레벨 && 캐릭터.레벨 < 71) {//고급
    ...
    public boolean 승급심사_통과_조건_확인(캐릭터 게임_캐릭터) {
        if (진행중인_퀘스트_운동_실행_횟수 >= 해야할_운동횟수) {
            switch(게임_캐릭터.등급) {
                case 1:
                    System.out.println("축하합니다! 초급 심사를 통과하였습니다. 중급이 되셨습니다.");
                    게임_캐릭터.등급++;
                    break;
                case 2:
                    System.out.println("축하합니다! 중급 심사를 통과하였습니다. 고급이 되셨습니다.");
                    게임_캐릭터.등급++;
                    break;
                case 3:
                    System.out.println("축하합니다! 고급 심사를 통과하였습니다. 초월이 되셨습니다.");
                    게임_캐릭터.등급++;
                    break;
                case 4:
                    System.out.println("축하합니다! 초월 심사를 통과하였습니다. 게임이 종료됩니다.");
                    return true; // 게임 종료
            }
            해야할_운동횟수 = 0;
            진행중인_퀘스트_운동_실행_횟수 = 0;
