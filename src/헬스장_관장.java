...
public class 헬스장_관장 {
    ...
    public void 승급_심사_통과_체크(캐릭터 게임_캐릭터, 게임운영 게임운영) {
        if (게임_캐릭터.등급 == 1) {
            if (게임_캐릭터.체력 > 0 && 초급_승급_심사_해야할_운동횟수 <= 0) {
                System.out.println("축하합니다! 승급 심사를 통과하셨습니다.");
                게임_캐릭터.등급 ++;
            } else {
                System.out.println("승급 심사를 실패하셨습니다.");
                승급심사_진행중 = false;
            }
        } else if (게임_캐릭터.등급 == 2) {
            if (게임_캐릭터.체력 > 0 && 중급_승급_심사_해야할_운동횟수 <= 0) {
                System.out.println("축하합니다! 승급 심사를 통과하셨습니다.");
                게임_캐릭터.등급 ++;
            } else {
                System.out.println("승급 심사를 실패하셨습니다.");
            ...
            if (게임_캐릭터.체력 > 0 && 고급_승급_심사_해야할_운동횟수 <= 0) {
                System.out.println("축하합니다! 승급 심사를 통과하셨습니다.");
                게임_캐릭터.등급 ++;
            } else {
                System.out.println("승급 심사를 실패하셨습니다.");
            ...
            if (게임_캐릭터.체력 > 0 && 초월_승급_심사_해야할_운동횟수 <= 0) {
                System.out.println("축하합니다! 승급 심사를 통과하셨습니다.");
