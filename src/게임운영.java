...
public class 게임운영 {
    ...
    public void 승급_가능_메시지_출력() {
        if (30 <= character.레벨 && character.레벨 < 31) {//초급
            System.out.println("중급 심사를 진행하실 수 있습니다.");
        } else if (50 <= character.레벨 && character.레벨 < 51) {//중급
            System.out.println("고급 심사를 진행하실 수 있습니다.");
        } else if (70 <= character.레벨 && character.레벨 < 71) {//고급
    ...
    public void 소모품_구매_안내_메시지() {
        ...
        if (소모품_구매 == 1) {
            ...
            if (게임_캐릭터.골드 >= 총금액) {
                ...
                int bcaa_개수 = 가방_소지한_아이템.소지한_bcaa_개수 + 게임_캐릭터.소모품_구매();
            } else {
            ...
            if (게임_캐릭터.골드 >= 총금액) {
                ...
                int 탄수화물_보충제_개수 = 가방_소지한_아이템.소지한_탄수화물_보충제_개수 + 게임_캐릭터.소모품_구매();
            } else {
                System.out.println("골드가 부족합니다.");
            }
        } else if (소모품_구매 == 3) {
            ...
            if (게임_캐릭터.골드 >= 총금액) {
                ...
                int 프로틴 = 가방_소지한_아이템.소지한_프로틴_개수 + 게임_캐릭터.소모품_구매();
            } else {
                System.out.println("골드가 부족합니다.");
            }
        } else if (소모품_구매 == 4) {
            ...
            if (게임_캐릭터.골드 >= 총금액) {
                ...
                int 크레아틴_개수 = 가방_소지한_아이템.소지한_크레아틴_개수 + 게임_캐릭터.소모품_구매();
            } else {
                System.out.println("골드가 부족합니다.");
            }
        }
