...
public class 게임운영 {
    ...
    public void 소모품_안내_메시지() {
        ...
        if (소모품_구매 == 1) {
            ...
            if (현재_소지한_골드.골드 >= 총금액) {
                int 계산 = 현재_소지한_골드.골드 - 소모품_bcaa_가격.bcaa * bcaa_구매_개수_입력받기.소모품_구매();
            ...
            if (현재_소지한_골드.골드 >= 총금액) {
                int 계산 = 현재_소지한_골드.골드 - 소모품_탄수화물_보충제_가격.탄수화물_보충제 * 탄수화물_보충제_구매_개수_입력받기.소모품_구매();
                System.out.println(계산);
            ...
            if (현재_소지한_골드.골드 >= 총금액) {
                int 계산 = 현재_소지한_골드.골드 - 소모품_프로틴_가격.프로틴 * 프로틴_구매_개수_입력받기.소모품_구매();
                System.out.println(계산);
            ...
            if (현재_소지한_골드.골드 >= 총금액) {
                int 계산 = 현재_소지한_골드.골드 - 소모품_크레아틴_가격.크레아틴 * 크레아틴_구매_개수_입력받기.소모품_구매();
                System.out.println(계산);
