        ...
        while (!게임_진행.게임_종료) {
            ...
            if (메인_메뉴_선택 == 1) {//운동을 실행하고자 할 때 선택하는 메뉴
                ...
                while (게임_진행.운동_진행중) {
                 ...
                 while (가방.가방_메뉴_진행중) {
                     ...
                     if (가방_메뉴_선택_번호 == 1) {//장비 선택을 골랐을 때
                         ...
                         //장비가 있는지 여부 체크 해준다.  true면 하나라도 잇는거소  false면 아무 장비도 가방에 존재 하지 않는다.
                ...
                while (퀘스트.퀘스트_메뉴_진행중) {
                    ...
                    퀘스트.퀘스트_유형_선택(퀘스트_번호_선택, 게임_캐릭터.레벨, 게임_캐릭터.등급);//1. 퀘스트 2.승급 심사 둘 중 하나 선택
                    if (퀘스트_번호_선택 == 1) {//퀘스트 1번을 실행했을 때
                        int 퀘스트_승낙_여부_번호_선택 = 퀘스트.퀘스트_승낙_여부(scanner.nextInt());
                        if (퀘스트_승낙_여부_번호_선택 == 1) {
                            int 들고자_하는_바벨_중량선택 = 0;
                            boolean 중량들수_있는여부 = false;
                            체육관.중량_선택_성공_여부 = true;
                            while (체육관.중량_선택_성공_여부) {
                        ...
                        } else if (퀘스트_승낙_여부_번호_선택 == 2) {// 퀘스트를 거절했을 때 상황
                                    System.out.println("메뉴로 이동하겠습니다.");
                                    break;
                        } else {//퀘스트 승낙 여부 번호를 잘 못 입력했을 때 상황
                            System.out.println("잘 못 입력하셨습니다. 다시 입력해주세요.");
                        }
