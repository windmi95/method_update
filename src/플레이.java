            ...
            if (메인_메뉴_선택 == 1) {//운동을 실행하고자 할 때 선택하는 메뉴
                ...
                while (게임_진행.운동_진행중) {
                    ...
                    if (운동_메뉴_선택 == 1) {
                        ...
                        if (레벨업_했는지_여부_체크) {
                            int 스탯_번호_선택 = 게임_캐릭터.레벨업_이후_올릴_스탯_번호_선택(scanner.nextInt());
                        }
                 ...
                 while (가방.가방_메뉴_진행중) {
                     ...
                     if (가방_메뉴_선택_번호 == 1) {//장비 선택을 골랐을 때
                         ...
                         //장비가 있는지 여부 체크 해준다.  true면 하나라도 잇는거소  false면 아무 장비도 가방에 존재하지 않는다.
                ...
                while (퀘스트.퀘스트_메뉴_진행중) {
                    ...
                    int 퀘스트_승낙_여부 = 0;
                    퀘스트.퀘스트_유형_선택(퀘스트_번호_선택, 퀘스트_승낙_여부, 게임_캐릭터.레벨, 게임_캐릭터.등급);//1. 퀘스트 2.승급 심사 둘 중 하나 선택
                    if (퀘스트_번호_선택 == 1) {//퀘스트 1번을 실행했을 때
                        퀘스트.퀘스트_진행_여부();
                        퀘스트_승낙_여부 = scanner.nextInt();
                        if (퀘스트_승낙_여부 == 1) {
                            int 들고자_하는_바벨_중량선택 = 0;
                            boolean 중량들수_있는여부 = false;
                            체육관.중량_선택_성공_여부 = true;
                            while (체육관.중량_선택_성공_여부) {//중량 선택
                                체육관.중량_선택(게임_캐릭터.레벨, 게임_캐릭터.등급);
                                들고자_하는_바벨_중량선택 = scanner.nextInt();
                                중량들수_있는여부 = 체육관.선택할_수_있는_무게체크(들고자_하는_바벨_중량선택, 게임_캐릭터.레벨, 게임_캐릭터.등급);
                                if (중량들수_있는여부) {
                            ...
                            게임_진행.운동_진행중 = true;
                            while (게임_진행.운동_진행중) {//퀘스트 -> 운동실행
                                체육관.운동_메뉴();
                                int 운동_메뉴_선택 = 체육관.운동_메뉴_선택(scanner.nextInt());
                                if (운동_메뉴_선택 == 1) {
                                    System.out.println("실행해야 하는 운동횟수 -> " + 퀘스트.랜덤_운동횟수);
                                    체육관.운동횟수++;
                                    System.out.println("운동횟수 -> " + 체육관.운동횟수);
                                    int 남은횟수 = 퀘스트.랜덤_운동횟수 - 체육관.운동횟수;
                                ...
                                } else if (운동_메뉴_선택 == 2) {//아이템 사용을 선택했을 경우
                                    가방.소모품_목록();
                                    가방.소모품_사용(scanner.nextInt(), 게임_캐릭터);
                                    break;
                                } else if (운동_메뉴_선택 == 3) {//게임 플레이 취소를 했을 경우
